...
| [박지섭](#)                                                                                           | [송시은](#)                                                                                                                                                                                                                                 | [조인성](#)                                                                                                     | [전유진](#)                                                                                                            | [손수진](#)                                                                                                        |
| :---------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :-------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------- |
| ![](박지섭_이미지링크)                                                                                | ![](송시은_이미지링크)                                                                                                                                                                                                                      | ![](조인성_이미지링크)                                                                                          | ![](전유진_이미지링크)                                                                                                 | ![](손수진_이미지링크)                                                                                             |
| - 프로젝트 초기 구성<br>- CI/CD 구축<br>- 랜딩 페이지<br>- Header/Footer<br>- SEO 설정<br>- 데모 발표 | - 라우터 설정<br>- API 함수 관리<br>(axiosInstance, request 유틸 함수)<br>- 에러 처리 관리<br>(Global, API, Render 바운더리 / 404, 500 에러 페이지)<br>- 로딩 UI<br>(PendingUI, Splash)<br>- 크레딧 부족 모달<br>- 리드미 작성 및 문서 정리 | - 스타일 시스템 구축<br>- 반응형 대응<br>- 버튼 컴포넌트 개발<br>- 후원 캐러셀<br>- 후원하기 모달<br>- 데모 PPT | - 크레딧 충전 모달<br>- 리스트 페이지<br>- 차트 페이지네이션<br>- 모달 시스템 구축<br>- 로딩 스피너 구현<br>- 데모 PPT | - 마이페이지 구현<br>- 라디오 버튼 UI<br>- 투표 모달<br>- 토스트 알림 컴포넌트<br>- 랜딩페이지<br>- 데모 영상, gif |
